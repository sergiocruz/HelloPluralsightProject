...
describe('Your HTML Page', function() {
  ...
  it('should have a title that contains your name @title', function() {
    assert.notEqual(window.$('title').text(), '', 'Make sure to set the content of the `title` element to your name.');
  });
  ...
  it('should have content in the h1 element @h1', function() {
    assert.equal(window.$('h1').text(), 'Hello, Pluralsight!', "Make sure to set the content of your `h1` element to 'Hello, Pluralsight!'.");
  });
